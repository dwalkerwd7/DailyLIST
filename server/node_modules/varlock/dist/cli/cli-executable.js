import { commandSpec as commandSpec$5 } from '../chunk-YQKD7US6.js';
import { commandSpec as commandSpec$6 } from '../chunk-XQURF2UG.js';
import { commandSpec as commandSpec$7 } from '../chunk-XM6D5XIS.js';
import { commandSpec } from '../chunk-WZKWJ7U2.js';
import '../chunk-Y3ITSQA4.js';
import { fmt } from '../chunk-HSIHCSJK.js';
import { commandSpec as commandSpec$1 } from '../chunk-A2HUIC6U.js';
import { commandSpec as commandSpec$2 } from '../chunk-PZZHI3DT.js';
import { commandSpec as commandSpec$3 } from '../chunk-HNG2WVGF.js';
...
import { checkBunVersion } from '../chunk-ZIMSE3Z5.js';
import { InvalidEnvError } from '../chunk-YBSEQARI.js';
import '../chunk-HSRXSFTK.js';
import { gracefulExit, asyncExitHook } from '../chunk-PPIQGMSC.js';
import { ansis_default, getUserVarlockDir } from '../chunk-CBO5NXPJ.js';
...
var debug = createDebug("varlock:telemetry");
var TRUE_ENV_VAR_VALUES = ["true", "1", "t"];
var userVarlockDirPath = getUserVarlockDir();
...
subCommands.set("init", buildLazyCommand(commandSpec, async () => await import('../init.command-AAOBYCKW.js')));
subCommands.set("load", buildLazyCommand(commandSpec$1, async () => await import('../load.command-SUKHW5LQ.js')));
subCommands.set("run", buildLazyCommand(commandSpec$2, async () => await import('../run.command-KJFQBQGX.js')));
subCommands.set("printenv", buildLazyCommand(commandSpec$3, async () => await import('../printenv.command-KDCKECCZ.js')));
subCommands.set("help", buildLazyCommand(commandSpec$4, async () => await import('../help.command-7E52XAOO.js')));
subCommands.set("telemetry", buildLazyCommand(commandSpec$5, async () => await import('../telemetry.command-V2RAWVUE.js')));
subCommands.set("scan", buildLazyCommand(commandSpec$6, async () => await import('../scan.command-NEPKTV65.js')));
subCommands.set("typegen", buildLazyCommand(commandSpec$7, async () => await import('../typegen.command-2TNVOO7Q.js')));
(/* @__PURE__ */ __name(async function go() {
  try {
    try {
      checkBunVersion();
    } catch (e) {
      throw new CliExitError(e.message, { forceExit: true });
    }
