      ...
      <div className="space-y-10">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-primary-text">
            ...
            <p>
              ...
              add notes, and switch between dark and light mode. That's it — no
              accounts, no sync, no notifications. Just a list.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <ul className="list-disc list-inside space-y-1 text-primary-text">
            ...
            <li>Express + Node.js (server) + TypeScript</li>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3 text-primary-text">
            <p>
              Built by <strong><a href="https://derekwalker.tech">Derek Walker</a></strong>, an aspiring full-stack engineer.
              <strong>DailyLIST</strong> is a portfolio project — an exercise in
              intentional design and shipping something clean rather than
              something utility-rich and usability-poor.
            </p>
            <p>
